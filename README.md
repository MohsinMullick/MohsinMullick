...
[![My Skills](https://skillicons.dev/icons?i=js,nextjs,react,html,css,md,tailwind,bootstrap,c,cpp,java,python,php,vue,nodejs,express,mongodb,postgres,sqlite,vscode,git,github,androidstudio,docker,firebase,tensorflow,figma,latex,matlab&perline=14)](https://skillicons.dev)
